...
pub use dispatcher::{
    ...
    transcribe, transcribe_with_key, upstream_retry_after, Completion, CompletionStreamEvent,
    EmbedBatchCompletion, EmbedCompletion, StreamingCompletion, ThinkingBudget, ThinkingMode,
