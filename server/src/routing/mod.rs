...
pub use dispatcher::{
    ...
    embed_with_key, resolve_route, resolve_route_candidates, resolve_thinking_budget,
    resolve_transcribe_candidates, transcribe, transcribe_with_key, upstream_retry_after,
    Completion, CompletionStreamEvent, EmbedCompletion, StreamingCompletion, ThinkingBudget,
