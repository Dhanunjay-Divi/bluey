...
> Historical commercialization plan. Its platform statements are not current;
> use the signed live manifest and `INSTALL.md`. Current consent and
> data-control requirements live in `SETTINGS-UI-CONTRACT.md` and
> `PRODUCT-STRATEGY.md`.
