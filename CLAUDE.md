# CLAUDE.md — Development Rules for Cue (Bluey)
...
This document governs both AI agents (Codex, Claude) and human developers. When in doubt, optimize for clarity and auditability over brevity.
