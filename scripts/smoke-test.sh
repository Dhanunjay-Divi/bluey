...
audio_start_output="$(./target/debug/bluey audio start 2>&1 || true)"
sleep 2
...
printf 'Bluey smoke test passed: daemon, overlay, transcript, instructions, context, memory, real-audio gating, AI routing scaffold, cloud scaffold, ask, action-items, recap, and archive all worked.\n'
