...
--
-- Snapshot bytes live in account-scoped object storage. PostgreSQL remains
-- the authority for generation fencing and exact runner ownership.
CREATE TABLE IF NOT EXISTS jobs_browser_profile_snapshots (
  ...
  envelope_version   BIGINT NOT NULL CHECK(envelope_version > 0),
