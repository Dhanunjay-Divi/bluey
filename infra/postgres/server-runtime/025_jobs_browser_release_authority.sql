...
CREATE TABLE IF NOT EXISTS jobs_browser_release_trust_policies (
  ...
  key_count                     BIGINT NOT NULL CHECK(key_count BETWEEN 4 AND 64),
...
CREATE TABLE IF NOT EXISTS jobs_browser_release_trust_keys (
  ...
  minimum_trust_generation      BIGINT NOT NULL
    CHECK(minimum_trust_generation BETWEEN 1 AND 9007199254740991),
  maximum_trust_generation      BIGINT NOT NULL
...
CREATE TABLE IF NOT EXISTS jobs_browser_release_manifests (
  ...
  artifact_count               BIGINT NOT NULL CHECK(artifact_count = 5),
...
CREATE TABLE IF NOT EXISTS jobs_browser_release_activations (
  ...
  activation_generation           BIGINT NOT NULL UNIQUE
...
CREATE TABLE IF NOT EXISTS jobs_browser_release_channel_transitions (
  ...
  previous_trust_generation       BIGINT,
  previous_channel_sequence       BIGINT,
  next_activation_sha256          TEXT NOT NULL,
  next_manifest_sha256            TEXT NOT NULL,
  next_trust_generation           BIGINT NOT NULL
...
CREATE TABLE IF NOT EXISTS jobs_browser_account_channel_assignments (
  ...
  assigned_at_ms                  BIGINT NOT NULL CHECK(assigned_at_ms >= 0),
...
CREATE TABLE IF NOT EXISTS jobs_local_run_release_bindings (
  ...
  account_channel_assignment_generation BIGINT NOT NULL
    CHECK(account_channel_assignment_generation >= 1),
  channel                         TEXT NOT NULL CHECK(channel IN ('internal', 'beta', 'stable')),
  channel_head_revision           BIGINT NOT NULL CHECK(channel_head_revision >= 1),
  ...
  trust_generation                BIGINT NOT NULL CHECK(trust_generation >= 1),
  trust_policy_sha256              TEXT NOT NULL,
  channel_sequence                BIGINT NOT NULL CHECK(channel_sequence >= 1),
  manifest_signature_set_sha256   TEXT NOT NULL,
  ...
  artifact_sha256                 TEXT NOT NULL
    CHECK(length(artifact_sha256) = 64 AND lower(artifact_sha256) = artifact_sha256),
  bound_at_ms                     BIGINT NOT NULL CHECK(bound_at_ms >= 0),
...
CREATE OR REPLACE FUNCTION reject_jobs_browser_global_release_authority_mutation()
RETURNS trigger LANGUAGE plpgsql AS $$
BEGIN
  RAISE EXCEPTION 'Browser release authority is immutable';
END;
$$;

DROP TRIGGER IF EXISTS trg_jobs_browser_release_signature_sets_no_update
  ON jobs_browser_release_signature_sets;
CREATE TRIGGER trg_jobs_browser_release_signature_sets_no_update
BEFORE UPDATE ON jobs_browser_release_signature_sets
FOR EACH ROW EXECUTE FUNCTION reject_jobs_browser_global_release_authority_mutation();
DROP TRIGGER IF EXISTS trg_jobs_browser_release_signature_sets_no_delete
  ON jobs_browser_release_signature_sets;
CREATE TRIGGER trg_jobs_browser_release_signature_sets_no_delete
BEFORE DELETE ON jobs_browser_release_signature_sets
FOR EACH ROW EXECUTE FUNCTION reject_jobs_browser_global_release_authority_mutation();

DROP TRIGGER IF EXISTS trg_jobs_browser_release_signatures_no_update
  ON jobs_browser_release_signatures;
CREATE TRIGGER trg_jobs_browser_release_signatures_no_update
BEFORE UPDATE ON jobs_browser_release_signatures
FOR EACH ROW EXECUTE FUNCTION reject_jobs_browser_global_release_authority_mutation();
DROP TRIGGER IF EXISTS trg_jobs_browser_release_signatures_no_delete
  ON jobs_browser_release_signatures;
CREATE TRIGGER trg_jobs_browser_release_signatures_no_delete
BEFORE DELETE ON jobs_browser_release_signatures
FOR EACH ROW EXECUTE FUNCTION reject_jobs_browser_global_release_authority_mutation();

DROP TRIGGER IF EXISTS trg_jobs_browser_release_trust_policies_no_update
  ON jobs_browser_release_trust_policies;
CREATE TRIGGER trg_jobs_browser_release_trust_policies_no_update
BEFORE UPDATE ON jobs_browser_release_trust_policies
FOR EACH ROW EXECUTE FUNCTION reject_jobs_browser_global_release_authority_mutation();
DROP TRIGGER IF EXISTS trg_jobs_browser_release_trust_policies_no_delete
  ON jobs_browser_release_trust_policies;
CREATE TRIGGER trg_jobs_browser_release_trust_policies_no_delete
BEFORE DELETE ON jobs_browser_release_trust_policies
FOR EACH ROW EXECUTE FUNCTION reject_jobs_browser_global_release_authority_mutation();

DROP TRIGGER IF EXISTS trg_jobs_browser_release_trust_keys_no_update
  ON jobs_browser_release_trust_keys;
CREATE TRIGGER trg_jobs_browser_release_trust_keys_no_update
BEFORE UPDATE ON jobs_browser_release_trust_keys
FOR EACH ROW EXECUTE FUNCTION reject_jobs_browser_global_release_authority_mutation();
DROP TRIGGER IF EXISTS trg_jobs_browser_release_trust_keys_no_delete
  ON jobs_browser_release_trust_keys;
CREATE TRIGGER trg_jobs_browser_release_trust_keys_no_delete
BEFORE DELETE ON jobs_browser_release_trust_keys
FOR EACH ROW EXECUTE FUNCTION reject_jobs_browser_global_release_authority_mutation();

DROP TRIGGER IF EXISTS trg_jobs_browser_release_manifests_no_update
  ON jobs_browser_release_manifests;
CREATE TRIGGER trg_jobs_browser_release_manifests_no_update
BEFORE UPDATE ON jobs_browser_release_manifests
FOR EACH ROW EXECUTE FUNCTION reject_jobs_browser_global_release_authority_mutation();
DROP TRIGGER IF EXISTS trg_jobs_browser_release_manifests_no_delete
  ON jobs_browser_release_manifests;
CREATE TRIGGER trg_jobs_browser_release_manifests_no_delete
BEFORE DELETE ON jobs_browser_release_manifests
FOR EACH ROW EXECUTE FUNCTION reject_jobs_browser_global_release_authority_mutation();

DROP TRIGGER IF EXISTS trg_jobs_browser_release_artifacts_no_update
  ON jobs_browser_release_artifacts;
CREATE TRIGGER trg_jobs_browser_release_artifacts_no_update
BEFORE UPDATE ON jobs_browser_release_artifacts
FOR EACH ROW EXECUTE FUNCTION reject_jobs_browser_global_release_authority_mutation();
DROP TRIGGER IF EXISTS trg_jobs_browser_release_artifacts_no_delete
  ON jobs_browser_release_artifacts;
CREATE TRIGGER trg_jobs_browser_release_artifacts_no_delete
BEFORE DELETE ON jobs_browser_release_artifacts
FOR EACH ROW EXECUTE FUNCTION reject_jobs_browser_global_release_authority_mutation();

DROP TRIGGER IF EXISTS trg_jobs_browser_release_activations_no_update
  ON jobs_browser_release_activations;
CREATE TRIGGER trg_jobs_browser_release_activations_no_update
BEFORE UPDATE ON jobs_browser_release_activations
FOR EACH ROW EXECUTE FUNCTION reject_jobs_browser_global_release_authority_mutation();
DROP TRIGGER IF EXISTS trg_jobs_browser_release_activations_no_delete
  ON jobs_browser_release_activations;
CREATE TRIGGER trg_jobs_browser_release_activations_no_delete
BEFORE DELETE ON jobs_browser_release_activations
FOR EACH ROW EXECUTE FUNCTION reject_jobs_browser_global_release_authority_mutation();

DROP TRIGGER IF EXISTS trg_jobs_browser_release_rollbacks_no_update
  ON jobs_browser_release_rollbacks;
CREATE TRIGGER trg_jobs_browser_release_rollbacks_no_update
BEFORE UPDATE ON jobs_browser_release_rollbacks
FOR EACH ROW EXECUTE FUNCTION reject_jobs_browser_global_release_authority_mutation();
DROP TRIGGER IF EXISTS trg_jobs_browser_release_rollbacks_no_delete
  ON jobs_browser_release_rollbacks;
CREATE TRIGGER trg_jobs_browser_release_rollbacks_no_delete
BEFORE DELETE ON jobs_browser_release_rollbacks
FOR EACH ROW EXECUTE FUNCTION reject_jobs_browser_global_release_authority_mutation();

DROP TRIGGER IF EXISTS trg_jobs_browser_release_revocations_no_update
  ON jobs_browser_release_revocations;
CREATE TRIGGER trg_jobs_browser_release_revocations_no_update
BEFORE UPDATE ON jobs_browser_release_revocations
FOR EACH ROW EXECUTE FUNCTION reject_jobs_browser_global_release_authority_mutation();
DROP TRIGGER IF EXISTS trg_jobs_browser_release_revocations_no_delete
  ON jobs_browser_release_revocations;
CREATE TRIGGER trg_jobs_browser_release_revocations_no_delete
BEFORE DELETE ON jobs_browser_release_revocations
FOR EACH ROW EXECUTE FUNCTION reject_jobs_browser_global_release_authority_mutation();

DROP TRIGGER IF EXISTS trg_jobs_browser_release_channel_transitions_no_update
  ON jobs_browser_release_channel_transitions;
CREATE TRIGGER trg_jobs_browser_release_channel_transitions_no_update
BEFORE UPDATE ON jobs_browser_release_channel_transitions
FOR EACH ROW EXECUTE FUNCTION reject_jobs_browser_global_release_authority_mutation();
DROP TRIGGER IF EXISTS trg_jobs_browser_release_channel_transitions_no_delete
  ON jobs_browser_release_channel_transitions;
CREATE TRIGGER trg_jobs_browser_release_channel_transitions_no_delete
BEFORE DELETE ON jobs_browser_release_channel_transitions
FOR EACH ROW EXECUTE FUNCTION reject_jobs_browser_global_release_authority_mutation();

CREATE OR REPLACE FUNCTION reject_jobs_browser_channel_head_delete()
RETURNS trigger LANGUAGE plpgsql AS $$
BEGIN
  RAISE EXCEPTION 'Browser release channel head cannot be deleted';
END;
$$;

DROP TRIGGER IF EXISTS trg_jobs_browser_release_channel_heads_no_delete
  ON jobs_browser_release_channel_heads;
CREATE TRIGGER trg_jobs_browser_release_channel_heads_no_delete
BEFORE DELETE ON jobs_browser_release_channel_heads
FOR EACH ROW EXECUTE FUNCTION reject_jobs_browser_channel_head_delete();

CREATE OR REPLACE FUNCTION reject_jobs_browser_bound_authority_update()
RETURNS trigger LANGUAGE plpgsql AS $$
BEGIN
  RAISE EXCEPTION 'bound Browser release authority is immutable';
END;
$$;

DROP TRIGGER IF EXISTS trg_jobs_browser_account_channel_assignments_no_update
  ON jobs_browser_account_channel_assignments;
CREATE TRIGGER trg_jobs_browser_account_channel_assignments_no_update
BEFORE UPDATE ON jobs_browser_account_channel_assignments
FOR EACH ROW EXECUTE FUNCTION reject_jobs_browser_bound_authority_update();

DROP TRIGGER IF EXISTS trg_jobs_local_run_release_bindings_no_update
  ON jobs_local_run_release_bindings;
CREATE TRIGGER trg_jobs_local_run_release_bindings_no_update
BEFORE UPDATE ON jobs_local_run_release_bindings
FOR EACH ROW EXECUTE FUNCTION reject_jobs_browser_bound_authority_update();

DROP TRIGGER IF EXISTS trg_jobs_local_run_claim_replays_no_update
  ON jobs_local_run_claim_replays;
CREATE TRIGGER trg_jobs_local_run_claim_replays_no_update
