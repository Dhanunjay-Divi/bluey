...
DROP TRIGGER IF EXISTS trg_jobs_browser_release_runtime_components_no_update
  ON jobs_browser_release_artifact_runtime_components;
CREATE TRIGGER trg_jobs_browser_release_runtime_components_no_update
...
DROP TRIGGER IF EXISTS trg_jobs_browser_release_runtime_components_no_delete
  ON jobs_browser_release_artifact_runtime_components;
CREATE TRIGGER trg_jobs_browser_release_runtime_components_no_delete
